...
public class PathListPage extends AbstractPageContainerManagedImpl implements Serializable {
	...
	protected WindowContainerManagedWindowBuilder __getWindowContainerManagedWindowBuilder__() {
		return __inject__(WindowContainerManagedWindowBuilderGetter.class).setContainerManaged(this)
				.setSystemAction(__inject__(SystemActionList.class).setEntityClass(Path.class))
				.execute().getOutput();
	}
